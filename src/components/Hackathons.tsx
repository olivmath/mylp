...
const Hackathons = () => {
  const hackathons = [
    ...
    },
    {
      ...
      year: "2022",
      position: "1º Lugar",
      description: "Bridge blockchain entre XRP Ledger e Ethereum com suporte a transferências cross-chain de múltiplos ativos",
      award: "🥇",
    ...
    },
    {
      ...
      year: "2022",
      position: "1º Lugar",
      description: "Game de estratégia com tokenomics integrados usando CHZ e mechanics de DeFi para engajamento de fãs",
      award: "🥇",
